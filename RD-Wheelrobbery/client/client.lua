...
function hasitem(itemname)
    ...
    if Config.Framework == "newesx" or Config.Framework == "oldesx" then --esx
        frameworkObject.TriggerServerCallback("RD-Wheelrobbery:server:hasitemesx", function(hasitem)
            hastheitem = hasitem
        end, itemname)     
...
RegisterNetEvent('RD-Wheelrobbery:client:stealwheel')
AddEventHandler('RD-Wheelrobbery:client:stealwheel', function()
    stealwheel()
end)
    ...
    if Config.Framework == "newesx" or Config.Framework == "oldesx" then --esx
        exports["esx_progressbar"]:Progressbar("Stealing Wheel", Config.WheelDuration,{
            ...
            onFinish = function()
                ...
                TriggerServerEvent("RD-Wheelrobbery:server:removeitem", Config.RequiredItem) -- remove item
                end
                TriggerServerEvent("RD-Wheelrobbery:server:giveitem", Config.WheelItem) -- give wheel
